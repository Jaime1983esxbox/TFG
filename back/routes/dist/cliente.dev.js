...
api.put('/actualizar_perfil_cliente_guest/:id', auth.auth, clienteController.actualizar_perfil_cliente_guest); // Dirección
...
api.get('/obtener_direccion_principal_cliente/:id', auth.auth, clienteController.obtener_direccion_principal_cliente); // Contacto

api.post('/enviar_mensaje_contacto', clienteController.enviar_mensaje_contacto); // Órdenes

api.get('/obtener_ordenes_cliente/:id', auth.auth, clienteController.obtener_ordenes_cliente);
api.get('/obtener_detalles_ordenes_cliente/:id', auth.auth, clienteController.obtener_detalles_ordenes_cliente); // Reviews
...
api.get('/obtener_reviews_cliente/:id', auth.auth, clienteController.obtener_reviews_cliente); // Exportar la inicialización de la ruta y el controlador de Cliente
