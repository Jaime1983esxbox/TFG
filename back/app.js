...
// Archivo que inicializa el back-end

var express = require('express');
// variable para inicializar el módulo express
var app = express();
var bodyparser = require('body-parser');
// variable para hacer la conexión a la BBDD
var mongoose = require('mongoose');
const { application } = require('express');
// variable para el puerto de ejecución al back-end, el puerto por defecto si no está disponible
var port = process.env.PORT || 4201; 
// variable para crear el servidor
var server = require('http').createServer(app);
// Inicialización del paquete socket.io,
